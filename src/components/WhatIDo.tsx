...
const WhatIDo = () => {
  ...
  useEffect(() => {
    // Enable interactivity for both touch and desktop
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">RLHF</div>
                <div className="what-tags">LLM Tuning</div>
                <div className="what-tags">OpenAI API</div>
                <div className="what-tags">LangChain</div>
                <div className="what-tags">Prompt Chaining</div>
              </div>
